...
namespace DAL.Model
{
    ...
    public partial class TeamStatistics
    {
        ...
        public AwayTeamStatisticsClass HomeTeamStatistics { get; set; }

        [JsonProperty("away_team_statistics")]
        public AwayTeamStatisticsClass AwayTeamStatistics { get; set; }
    ...
    public partial class AwayTeamStatisticsClass
    {
